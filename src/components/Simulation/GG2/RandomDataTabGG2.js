      ...
      <table className="w-full text-black">
        <thead>
          <tr>
            ...
            <th className='text-xl'>Cumulative Probability</th>
        ...
        <tbody>
          {simulatedData.map((data) => (
            <tr key={data.customer}>
              ...
              <td className='text-center pt-9 font-bold'>{data.probability}</td>
              <td className='text-center pt-9 font-bold'>{data.cumulativeProbability}</td>
